            ...
            <div class="table_heading">
                <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                        <button class="btn_all" @click="changeAction('email/addreminder')">+ Add Reminder</button>
                    </div>
                </div>
            </div>
            ...
            <div class="table_div_inner box_shadow_reg border-radius-reg">
                <table class="table mb-0">
                    ...
                    <tr v-for="(automation, index) in automations.data">
                        ...
                        <td>{{automation.total_opened}}</td>
                        <td>{{(automation.total_opened == 0) ? '-' : ((automation.total_opened / automation.total_sent) * 100).toFixed(1) + '%'}}</td>
                        ...
                        <td>
                            <button class="btn_table btn_blue font-400" @click="changeAction('email/editreminder/' + automation.id)">Edit</button>
...
export default {
    ...
    methods:{
        ...
        async getData(url = 'get-automations/email'){
            let base = this;
            base.isLoading = true;
            await axios.get(url)
                .then(res => {
                    ...
                    base.analytics = data.analytics.email;
                    base.shop = data.shop;
            })
            .catch(err => {
                console.log(err);
