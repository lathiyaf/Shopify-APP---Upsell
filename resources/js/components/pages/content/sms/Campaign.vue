<template>
    <div>
                ...
                <div class="col-5">
                    <div class="right_btn_div d-flex ml-auto justify-content-end">
                        <div class="white_btn d-flex justify-content-between align-items-center">
                            <p class="mb-0 ">SMS Credits: <span class="h3">$2.00</span></p>
                            <button class="btn_all">Add</button>
                        </div>
        ...
        <div class="table_div campaigns-list">
            <div class="table_heading">
                <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                        <button class="btn_all">+ Add Reminder</button>
                    </div>
                </div>
            </div>
            ...
            <div class="table_div_inner box_shadow_reg border-radius-reg">
                <table class="table mb-0">
                    ...
                    <tr>
                        <td>1</td>
                        <td>+91 9998884040</td>
                        <td>2021-03-27  10:09 PM</td>
                        <td><button class="btn_table btn_green font-400">Sent</button></td>
                        <td><button class=" ml-1 btn_table btn_red font-400">Remove</button> <button class="btn_table btn_blue font-400">Edit</button> </td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>+91 9998884040</td>
        ...
        <div class="pagination_container">
            <ul class="page_ul box_shadow_reg border-radius-reg">
                <li><i class="fa fa-angle-left"></i></li>
                <li class="page_li active_li">1</li>
                <li class="page_li">2</li>
                <li class="page_li">3</li>
                <li class="page_li">4</li>
                <li class="">...</li>
                <li class="page_li">10</li>
